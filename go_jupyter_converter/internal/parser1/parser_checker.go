...
func RunJupyterChecker(filePath string, cfg *utils.Config) float64 {
	...
	cmd := exec.Command("C:\\Users\\Albert Nedumudy\\AppData\\Local\\Programs\\Python\\Python311\\python.exe", "C:/Users/Albert Nedumudy/Desktop/Main HQ/Work/NNDL_Project/go_jupyter_converter/internal/executor/run_code.py")
